...
import com.example.abhi.utility.notes.DatabaseHandler;
import com.example.abhi.utility.notes.Note;
import com.example.abhi.utility.notes.NoteActivity;
import com.example.abhi.utility.notes.NoteAdapter;
...
public class Notes extends AppCompatActivity {
    ...
    private AlertDialog initAlertDialogDeleteAllNotes() {
        ...
        builder.setPositiveButton(this.getString(R.string.ok_button), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                deleteAllNotes();
                Toast.makeText(Notes.this, getString(R.string.delete_notes_success),
    ...
    private AlertDialog setupAlertDialogDeleteSingleNote() {
        ...
        builder.setPositiveButton(this.getString(R.string.ok_button), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                noteAdapter.notifyDataSetChanged();
                Toast.makeText(Notes.this, String.format(getString(R.string.note_deleted), selectedNote.getId()),
                        Toast.LENGTH_SHORT).show();
            }
        });
    ...
    void populateListView(ArrayList<Note> note) {
        noteAdapter = new NoteAdapter(this,
                R.layout.notelistview_item_row, note);
